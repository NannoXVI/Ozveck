...
local NavBar = {
    Normal = function()
        ...
        NavBarContent.ChildAdded:Connect(
            function(Child)
                pcall(
                    function()
                ...
                pcall(
                    function()
                        local Children = #NavBarContent:GetChildren() - 2
                        TweenService:Create(
                            Child:FindFirstChildWhichIsA("ImageLabel"),
                            TweenInfo.new(1),
                            {ImageTransparency = (Children > 1) and 0.5 or 0}
                        ):Play()
                    end
                )
                pcall(
...
function TryAddMenu(Object, Menu, ReturnTable)
    ...
    if Total > 0 then
        ...
        MenuBuild.Position =
            UDim2.fromOffset(MenuButton.AbsolutePosition.X, MenuButton.AbsolutePosition.Y) - UDim2.fromOffset(125, 5)
        MenuBuild.ZIndex = 100
        MenuBuild.ClipsDescendants = true
        MenuBuild.Parent = MainGUI

        MenuButton:GetPropertyChangedSignal("AbsolutePosition"):Connect(
            function()
                MenuBuild.Position =
                    UDim2.fromOffset(MenuButton.AbsolutePosition.X, MenuButton.AbsolutePosition.Y) -
                    UDim2.fromOffset(125, 5)
            end
        )
        ...
        MenuButton.MouseButton1Down:Connect(
            function()
                MenuToggle = not MenuToggle
                TweenService:Create(
                    MenuBuild,
                    TweenInfo.new(0.15),
                    {Size = MenuToggle and UDim2.fromOffset(120, Size) or UDim2.fromOffset(120, 0)}
                ):Play()
            end
        )
        ...
        table.foreach(
            ...
            function(Option, Value)
                if typeof(Value) == "function" then
                    ...
                    MenuOption.MouseButton1Down:Connect(
                        function()
                            Value(ReturnTable)
                            MenuToggle = false
...
function CreateNewButton(ButtonConfig, Parent)
    ...
    local ButtonCallback = ButtonConfig.Callback or function()
            print("nil button")
        end
...
function Material.Load(Config)
    ...
    TitleText.MouseButton1Down:Connect(
        function()
    ...
    MinimiseButton.MouseButton1Down:Connect(
        function()
            Open = not Open
    ...
    if NavBarMenu then
        ...
        NavBarMenu.MouseButton1Down:Connect(
            function()
                MenuToggle = not MenuToggle
                TweenService:Create(
                    NavigationBar,
                    TweenInfo.new(0.15),
                    {Size = (MenuToggle and UDim2.fromScale(0.5, 1) or UDim2.fromScale(0, 1)) - UDim2.fromOffset(0, 30)}
                ):Play()
                TweenService:Create(
                    NavBarOverlay,
                    TweenInfo.new(0.15),
                    {BackgroundTransparency = MenuToggle and 0.5 or 1}
                ):Play()
                if MenuToggle then
                    wait(0.15)
    ...
    function TabLibrary.Banner(BannerConfig)
        ...
        local ExistingBanner, ExistingBannerOverlay =
            MainFrame:FindFirstChild("BannerOverlay"),
            MainFrame:FindFirstChild("Banner")
        ...
        BannerOptions["Ok"] = function()
            TweenService:Create(
                BannerContainer,
                TweenInfo.new(0.5),
                {Size = UDim2.fromScale(1, 0) + UDim2.fromOffset(-10, 0)}
            ):Play()
        ...
        table.foreach(
            ...
            function(Option, Value)
                if typeof(Value) == "function" then
                    local TextSize =
                        TextService:GetTextSize(Option:upper(), 12, Enum.Font.GothamBold, Vector2.new(0, 0)).X
                    ...
                    OptionItem.MouseButton1Down:Connect(
                        function()
                            Value()
        ...
        TweenService:Create(
            BannerContainer,
            TweenInfo.new(0.5),
            {Size = UDim2.fromScale(1, 0) + UDim2.fromOffset(-10, 30)}
        ):Play()
    end
    ...
    function TabLibrary.New(TabConfig)
        ...
        if ImageID then
            if Title then
                ...
                local TextSize =
                    TextService:GetTextSize(Title:upper(), Settings.TextSize, Settings.Font, Settings.Vector).X
            ...
            local Image =
                RunService:IsStudio() and "http://www.roblox.com/asset/?id=5472131383" or
                game:GetObjects(FetchURL)[1].Texture
                ...
                for _, Track in next, ButtonTrack do
                    if not (Track == Button) then
                        ...
                        pcall(
                            function()
                                TweenService:Create(
                                    Track:FindFirstChildWhichIsA("ImageLabel"),
                                    TweenInfo.new(0.15),
        ...
        PageList:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(
            function()
        ...
        function OptionLibrary.Dropdown(DropdownConfig)
            ...
            local DropdownCallback = DropdownConfig.Callback or function()
                    print("nil dropdown")
                end
            ...
            local DropdownSize =
                UDim2.fromScale(1, 0) + UDim2.fromOffset(0, (NumberOfOptions * 20) + ((NumberOfOptions - 1) * 5))
            ...
            DropdownList:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(
                function()
                    if DropToggle then
                        DropdownContent.Size =
                            UDim2.fromScale(1, 0) + UDim2.fromOffset(DropdownList.AbsoluteContentSize.Y)
            ...
            DropdownTitle.MouseButton1Down:Connect(
                function()
                    ...
                    TweenService:Create(
                        DropdownContent,
                        TweenInfo.new(0.15),
                        {Size = DropToggle and DropdownSize or UDim2.fromScale(1, 0)}
                    ):Play()
                    TweenService:Create(
                        Dropdown,
                        TweenInfo.new(0.15),
                        {
                            Size = DropToggle and (DropdownSize + UDim2.fromOffset(0, 35)) or
                                (UDim2.fromScale(1, 0) + UDim2.fromOffset(0, 30))
                        }
                    ):Play()
                end
            )
        ...
        function OptionLibrary.ChipSet(ChipSetConfig)
            ...
            local ChipSetCallback = ChipSetConfig.Callback or function()
                    print("nil chipset")
                end
            ...
            if TotalOptions > 0 then
                ...
                table.foreach(
                    ...
                    function(Key, Value)
                        ...
                        ChipLabel.Size =
                            BuildTable[Key] and (UDim2.fromScale(1, 1) - UDim2.fromOffset(30)) or
                            (UDim2.fromScale(1, 1) - UDim2.fromOffset(5))
                        ...
                        ChipItem.MouseButton1Down:Connect(
                            function()
                                ...
                                TweenService:Create(
                                    ChipItem,
                                    TweenInfo.new(0.15),
                                    {ImageColor3 = Enabled and Theme.ChipSet or Theme.ChipSetAccent}
                                ):Play()
                                TweenService:Create(
                                    ChipShadow,
                                    TweenInfo.new(0.15),
                                ...
                                TweenService:Create(
                                    ...
                                    TweenInfo.new(0.15),
                                    {
                                        TextColor3 = Enabled and Theme.ChipSetAccent or Theme.ChipSet,
                                        Position = Enabled and UDim2.fromOffset(30) or UDim2.fromOffset(5),
                                        Size = Enabled and (UDim2.fromScale(1, 1) - UDim2.fromOffset(30)) or
                                            (UDim2.fromScale(1, 1) - UDim2.fromOffset(5))
                                    }
                                ):Play()
                                if ChipMenu then
                                    TweenService:Create(
                                        ChipMenu,
                                        TweenInfo.new(0.15),
                                        {ImageColor3 = Enabled and Theme.ChipSetAccent or Theme.ChipSet}
                                    ):Play()
                                end
                                ChipSetCallback(BuildTable)
                            end
                    ...
                    table.foreach(
                        ...
                        function(Key, Value)
                            ...
                            TweenService:Create(
                                Tick,
                                TweenInfo.new(0.5),
                                {ImageTransparency = BuildTable[Key] and 0 or 1}
                            ):Play()
                            TweenService:Create(ChipLabel, TweenInfo.new(0.5), {TextTransparency = 0}):Play()
        ...
        function OptionLibrary.DataTable(DataTableConfig)
            ...
            local DataTableCallback = DataTableConfig.Callback or function()
                    print("nil chipset")
                end
                ...
                table.foreach(
                    ...
                    function(Key, Value)
                        ...
                        TweenService:Create(
                            DataItem,
                            TweenInfo.new(0.5),
                            {ImageTransparency = BuildTable[Key] and 0.8 or 0}
                        ):Play()
                        TweenService:Create(
                            DataTracker,
                            TweenInfo.new(0.5),
                            {ImageTransparency = BuildTable[Key] and 0 or 0.8}
                        ):Play()
                        TweenService:Create(
                            Tick,
                            TweenInfo.new(0.5),
                            {ImageTransparency = BuildTable[Key] and 0 or 0.7}
                        ):Play()
                        ...
                        DataItem.MouseButton1Down:Connect(
                            function()
                                BuildTable[Key] = not BuildTable[Key]
                                local Enabled = BuildTable[Key]
                                TweenService:Create(
                                    ...
                                    TweenInfo.new(0.15),
                                    {
                                        ImageTransparency = Enabled and 0.8 or 0,
                                        ImageColor3 = Enabled and Theme.DataTable or Theme.DataTableAccent
                                    }
                                ):Play()
                                TweenService:Create(
                                    Tick,
                                    TweenInfo.new(0.15),
                                    {ImageTransparency = Enabled and 0 or 0.7}
                                ):Play()
                                TweenService:Create(
                                    DataTracker,
                                    TweenInfo.new(0.15),
                                    {ImageTransparency = Enabled and 0 or 0.8}
                                ):Play()
                                DataTableCallback(BuildTable)
                            end
                        )
        ...
        function OptionLibrary.ColorPicker(ColorPickerConfig)
            ...
            local ColorPickerCallback = ColorPickerConfig.Callback or function()
                    print("nil color picker")
                end
            ...
            ColorPicker.MouseButton1Down:Connect(
                function()
                    ...
                    TweenService:Create(
                        ...
                        TweenInfo.new(0.15),
                        {
                            Size = UDim2.fromScale(1, 0) +
                                (ColorPickerToggle and UDim2.fromOffset(0, 115) or UDim2.fromOffset(0, 40))
                        }
                    ):Play()
                end
            )
            ...
            ColorTracker:GetPropertyChangedSignal("ImageColor3"):Connect(
                function()
                    TrackerShadow.ImageColor3 = ColorTracker.ImageColor3
                end
            )
            ...
            S:GetPropertyChangedSignal("Value"):Connect(
                function()
                    ColorTracker.ImageColor3 = Color3.fromHSV(H.Value, S.Value, V.Value)
                    SaturationGrad.Color =
                        ColorSequence.new(
            ...
            HueTracker.MouseButton1Down:Connect(
                function()
            ...
            ValueTracker.MouseButton1Down:Connect(
                function()
            ...
            SaturationTracker.MouseButton1Down:Connect(
                function()
        ...
        function OptionLibrary.Toggle(ToggleConfig)
            ...
            local ToggleCallback = ToggleConfig.Callback or function()
                    print("nil toggle")
                end
            ...
            TweenService:Create(
                ...
                TweenInfo.new(0.15),
                {
                    Position = (ToggleDefault and UDim2.fromScale(1, 0.5) or UDim2.fromScale(0, 0.5)) -
                        UDim2.fromOffset(8, 8),
                    ImageColor3 = ToggleDefault and Theme.Toggle or Theme.ToggleAccent
                }
            ):Play()
        ...
        function OptionLibrary.TextField(TextFieldConfig)
            ...
            local TextFieldCallback = TextFieldConfig.Callback or function()
                    print("nil text field")
                end
        ...
        function OptionLibrary.Slider(SliderConfig)
            ...
            local SliderCallback = SliderConfig.Callback or function()
                    print("nil slider")
                end
            ...
            SliderDot.MouseButton1Down:Connect(
                function()
                    ...
                    MouseMove =
                        ...
                        function()
                            ...
                            TweenService:Create(
                                SliderDot,
                                TweenInfo.new(0.15),
                                {Position = UDim2.fromScale(Px, 0.5) - UDim2.fromOffset(5, 5)}
                            ):Play()
                            TweenService:Create(SliderFill, TweenInfo.new(0.15), {Size = UDim2.fromScale(Px, 1)}):Play()
                            SliderFadedDot.Size = UDim2.fromOffset(SizeFromScale, SizeFromScale)
                            SliderFadedDot.Position =
                                UDim2.fromScale(0.5, 0.5) - UDim2.fromOffset(SizeFromScale / 2, SizeFromScale / 2)
            ...
            function SliderLibrary:SetMin(Value)
                SliderMin = Value
                local SliderDef =
                    math.clamp(SliderConfig.Def, SliderMin, SliderMax) or math.clamp(50, SliderMin, SliderMax)
                local DefaultScale = (SliderDef - SliderMin) / (SliderMax - SliderMin)
                local SizeFromScale = (MinSize + (MaxSize - MinSize)) * DefaultScale
                SizeFromScale = SizeFromScale - (SizeFromScale % 2)
                SliderDot.Position =
                    UDim2.fromScale(DefaultScale, 0.5) - UDim2.fromOffset(SizeFromScale / 2, SizeFromScale / 2)
            end
